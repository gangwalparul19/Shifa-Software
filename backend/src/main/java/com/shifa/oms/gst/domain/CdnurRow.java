...
/**
 * One row of the GSTR-1 <strong>CDNUR</strong> section — a credit/debit note issued against an
 * unregistered-buyer (B2C) supply (GST filing compliance, Req 5.1, Req 2).
 *
 * <p>Unlike {@link CdnrRow}, there is no buyer GSTIN because the original supply was to an
 * unregistered buyer.
 *
